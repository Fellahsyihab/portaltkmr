...
class Admin_manrisk extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
         ...
         $this->load->view('admin_manrisk/index', $data);
...

    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('admin_manrisk');
               ...
               $this->db->update('admin_manrisk', $data);
               $this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert">
