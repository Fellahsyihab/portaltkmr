...
<head>
  ...
  <title>Menu Managememnt GCG</title>
...
<body id="page-top">
  ...
  <?php foreach ($admin_about as $am) : ?>
    <tr>
      ...
      <td><?= $am['url']; ?></td>
      <td>
      <a href="" class="btn btn-warning btn-sm mb-1" data-toggle="modal" data-target="#editmenuGCG<?= $am['id'];?>">Edit</a>
      <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#hapusmenuGCG<?= $am['id'];?>">Hapus</a>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
...
<!-- Tambah Menu -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?= base_url('admin_about'); ?>" method="POST">
   ...
   <!-- Edit Menu -->
<p hidden><?= $nomor = 1; ?></p>
<?php foreach ($admin_about as $am) : $nomor++; ?>
  <div class="modal fade" id="editmenuGCG<?= $am['id'];?>" tabindex="-1" role="dialog" aria-labelledby="tambahmenuEditLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form action="<?= base_url('admin_about/edit'); ?>" method="POST">
...
<p hidden><?= $nomor = 1; ?></p>
<?php foreach ($admin_about as $am) : $nomor++; ?>
<div class="modal fade" id="hapusmenuGCG<?= $am['id'];?>" tabindex="-1" role="dialog" aria-labelledby="hapusmenuGCGLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="hapusmenuGCGLabel">Hapus Data Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_about/hapus'); ?>" method="POST">
