...
<body id="page-top">
 ...
 <!-- Page Heading -->
    ...
    <!-- Tambah Menu -->
        <form action="<?= base_url('admin_menu/edit_elrn/') . $elrn_tkmr['id'] ?>" method="POST"   enctype="multipart/form-data">
        <input type ="hidden" name="id" id="id" value="<?= $elrn_tkmr['id']?>">
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul" name="judul"  value="<?= $elrn_tkmr['judul']?>" placeholder="JUDUL">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="link" name="link"  value="<?= $elrn_tkmr['link']?>" placeholder="LINK">
        </div>
        ...
        <div class="form-group-row">
            ...
            <div class="row">
            <div class="col-sm-3">
            <img src="<?= base_url('front-end/assets/img/elearning/') . $elrn_tkmr['image']?>" class="img-thumbnail" alt="Image">
        </div>
        </div>
        </div>
        </div>
