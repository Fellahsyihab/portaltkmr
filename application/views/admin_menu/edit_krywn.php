...
<body id="page-top">
 ...
 <!-- Page Heading -->
    ...
    <!-- Tambah Menu -->
        <form action="<?= base_url('admin_menu/edit_krywn/') . $krywn_tkmr['id'] ?>" method="POST"   enctype="multipart/form-data">
        <input type ="hidden" name="id" id="id" value="<?= $krywn_tkmr['id']?>">
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="nama" name="nama"  value="<?= $krywn_tkmr['nama']?>" placeholder="NAMA">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="jabatan" name="jabatan"  value="<?= $krywn_tkmr['jabatan']?>" placeholder="JABATAN">
        </div>
        ...
        <div class="form-group-row">
            ...
            <div class="row">
            <div class="col-sm-3">
            <img src="<?= base_url('front-end/assets/img/karyawan/') . $krywn_tkmr['image']?>" class="img-thumbnail" alt="Image">
        </div>
        </div>
        </div>
        </div>
