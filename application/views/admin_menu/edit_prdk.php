...
<body id="page-top">
 ...
 <!-- Page Heading -->
    ...
    <!-- Tambah Menu -->
        <form action="<?= base_url('admin_menu/edit_prdk/') . $prdk_tkmr['id'] ?>" method="POST"   enctype="multipart/form-data">
        <input type ="hidden" name="id" id="id" value="<?= $prdk_tkmr['id']?>">
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul" name="judul"  value="<?= $prdk_tkmr['judul']?>" placeholder="JUDUL">
        </div>
        ...
        <div class="form-group-row">
            ...
            <div class="row">
            <div class="col-sm-3">
            <img src="<?= base_url('front-end/assets/img/produk/') . $prdk_tkmr['image']?>" class="img-thumbnail" alt="Image">
        </div>
        </div>
        </div>
        </div>
