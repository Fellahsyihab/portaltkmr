...
<body id="page-top">
 ...
 <!-- Page Heading -->
    ...
    <!-- Tambah Menu -->
        <form action="<?= base_url('admin_menu/edit_skls/') . $skls_tkmr['id'] ?>" method="POST"   enctype="multipart/form-data">
        <input type ="hidden" name="id" id="id" value="<?= $skls_tkmr['id']?>">
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul" name="judul"  value="<?= $skls_tkmr['judul']?>" placeholder="JUDUL">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="bio" name="bio"  value="<?= $skls_tkmr['bio']?>" placeholder="BIO">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="text" id="text" placeholder="ISI" cols="30" rows="10"><?= $skls_tkmr['text']?></textarea>
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="next" id="next" placeholder="ISI" cols="30" rows="10"><?= $skls_tkmr['next']?></textarea>
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="nama" name="nama"  value="<?= $skls_tkmr['nama']?>" placeholder="NAMA">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="jbt" name="jbt"  value="<?= $skls_tkmr['jbt']?>" placeholder="JABATAN">
        </div>
        ...
        <div class="form-group-row">
            ...
            <div class="row">
            <div class="col-sm-3">
            <img src="<?= base_url('front-end/assets/img/Header_Beranda/') . $skls_tkmr['gambar']?>" class="img-thumbnail" alt="Image">
        </div>
        </div>
        </div>
        </div>
