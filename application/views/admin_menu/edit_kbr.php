...
<body id="page-top">
 ...
 <!-- Page Heading -->
    ...
    <!-- Tambah Menu -->
        <form action="<?= base_url('admin_menu/edit_kbr/') . $kbr_tkmr['id'] ?>" method="POST"   enctype="multipart/form-data">
        <input type ="hidden" name="id" id="id" value="<?= $kbr_tkmr['id']?>">
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul" name="judul"  value="<?= $kbr_tkmr['judul']?>" placeholder="JUDUL">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="slug" name="slug"  value="<?= $kbr_tkmr['slug']?>" placeholder="SLUG">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="isi" id="editor" placeholder="ISI" cols="30" rows="10"><?= $kbr_tkmr['isi']?></textarea>
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="pembuat" name="pembuat"  value="<?= $kbr_tkmr['pembuat']?>" placeholder="PEMBUAT">
        </div>
        ...
        <div class="form-group-row">
            ...
            <div class="row">
            <div class="col-sm-3">
            <img src="<?= base_url('front-end/assets/img/berita/') . $kbr_tkmr['gambar']?>" class="img-thumbnail" alt="Image">
        </div>
        </div>
        </div>
        </div>
