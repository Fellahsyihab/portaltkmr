...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahkrywnModal">Tambah KARYAWAN</a> 
 ...
 <!-- Page Heading -->
          ...
          <div>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">TKMR TEAM</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>     
                    <?php foreach ($krywn_tkmr as $kry) : ?>              
                     ...
                     <td> <img class="img-thumbnail" width="180px" src="<?= base_url('front-end/assets/img/karyawan/'). $kry['image']?>" class="img-thumbnail" alt=""></td>
                     <td><?=$kry['nama']?></td>
                     <td><?=$kry['jabatan']?></td>
                     <td>
                        <a href="<?= base_url('admin_menu/edit_krywn/') . $kry['id'];?> "class="btn btn-sm btn-warning">Edit</a>
    ...
    <!-- Tambah Menu -->
    <div class="modal fade" id="tambahkrywnModal" tabindex="-1" role="dialog" aria-labelledby="tambahkrywnModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahkrywnModalLabel">Tambah Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/krywn_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
