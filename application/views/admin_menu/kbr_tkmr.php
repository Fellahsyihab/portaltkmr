...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahBERITAModal">Tambah BERITA</a>
 ...
 <!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$kbmr['judul']?></h6>
                </div>
                  
                <div class="card-body">
                  <img src="<?= base_url('front-end/assets/img/berita/') . $kbmr['gambar']?>" class="img-thumbnail" alt="">
                  <p><?= substr(strip_tags($kbmr['isi']), 0, 100); ?></p>
                  <a href="<?= base_url('admin_menu/edit_kbr/') . $kbmr['id'];?>" class="btn btn-sm btn-warning">Edit</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?= base_url('admin_menu/kbr_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
        ...
        <div class="form-group mb-3">
        <textarea class="form-control" name="isi" id="editor" placeholder="ISI" cols="30" rows="10"></textarea>
        </div>
        <div class="form-group mb-3">
...
<!-- Tambah Menu -->
  ...
  <script src="<?= base_url('back-end/'); ?>dist/sweetalert2.all.min.js"></script>
