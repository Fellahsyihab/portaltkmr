...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahbannerModal">Tambah Banner</a>
 ...
 <!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <img src="<?= base_url('front-end/assets/img/Header_Beranda/'). $bi['gambar']?>" class="img-thumbnail" alt="">
              </div>
              </div>
           </div>
              <?php endforeach; ?>
