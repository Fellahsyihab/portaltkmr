...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahphrgtkmrModal">Tambah Banner</a> 
 ...
 <!-- Page Heading -->
          ...
          <div>
           ...
           <!-- Basic Card Example -->
           <?php foreach ($phrg_tkmr as $phmr) : ?>
        <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['thn1']?></h6>
                </div>
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['judul1']?></h6>
                </div>
                <div class="card-body">
                <?=$phmr['text1']?>
                </div>
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['thn2']?></h6>
                </div>  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['judul2']?></h6>
                </div>  
                <div class="card-body">
                <?=$phmr['text2']?>
                </div>
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['thn3']?></h6>
                </div>  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['judul3']?></h6>
                </div>  
                <div class="card-body">
                <?=$phmr['text3']?>
              </div>
              <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['thn4']?></h6>
                </div>  
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"><?=$phmr['judul4']?></h6>
                </div>  
                <div class="card-body">
                <?=$phmr['text4']?>
            </div>
    ...
    <!-- Tambah Menu -->
    <div class="modal fade" id="tambahphrgtkmrModal" tabindex="-1" role="dialog" aria-labelledby="tambahphrgtkmrModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahphrgtkmrModalLabel">Tambah Banner</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/phrg_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="thn1" name="thn1" placeholder="Tahun">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul1" name="judul1" placeholder="Judul">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="text1" id="text1" placeholder="Detail Bio" cols="30" rows="10"></textarea>
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="thn2" name="thn2" placeholder="Tahun">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul2" name="judul2" placeholder="Judul">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="text2" id="text2" placeholder="Detail Bio" cols="30" rows="10"></textarea>
        </div>
            <div class="form-group mb-3">
        <input type="text" class="form-control" id="thn3" name="thn3" placeholder="Tahun">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul3" name="judul3" placeholder="Judul">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="text3" id="text3" placeholder="Detail Bio" cols="30" rows="10"></textarea>
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="thn4" name="thn4" placeholder="Tahun">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="judul4" name="judul4" placeholder="Judul">
        </div>
        <div class="form-group mb-3">
        <textarea class="form-control" name="text4" id="text4" placeholder="Detail Bio" cols="30" rows="10"></textarea>
        </div>
