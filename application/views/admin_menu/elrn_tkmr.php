...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahELRNModal">Tambah E-LEARNING</a> 
 ...
 <!-- Page Heading -->
          ...
          <div>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">TKMR E-LEARNING</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php foreach ($elrn_tkmr as $elrn) : ?>           
                     ...
                     <td> <img class="img-thumbnail" width="180px" src="<?= base_url('front-end/assets/img/elearning/'). $elrn['image']?>" class="img-thumbnail" alt=""></td>
                     <td><?=$elrn['judul']?></td>
                     <td><?=$elrn['link']?></td>
                     <td>
                        <a href="<?= base_url('admin_menu/edit_elrn/') . $elrn['id'];?>" class="btn btn-sm btn-warning">Edit</a>
    ...
    <!-- Tambah Menu -->
    <div class="modal fade" id="tambahELRNModal" tabindex="-1" role="dialog" aria-labelledby="tambahELRNModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahELRNModalLabel">Tambah Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/elrn_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
        <div class="modal-body">
        <div class="form-group mb-3">
        
        <input type="text" class="form-control" id="judul" name="judul" placeholder="JUDUL E-LEARNING">
        </div>
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="link" name="link" placeholder="LINK E-LEARNING">
        </div>
        
        <div class="custom-file">
        <input type="file" class="custom-file" id="image" name="image" placeholder="POSTER">
