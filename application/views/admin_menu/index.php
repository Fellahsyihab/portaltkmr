...
<body id="page-top">
  ...
  <?php foreach ($admin_menu as $am) : ?>
    <tr>
      ...
      <a href="" class="btn btn-warning btn-sm mb-1" data-toggle="modal" data-target="#tambahmenuEdit<?= $am['id'];?>">Edit</a>
        
      <a href="" class="btn btn-danger btn-sm mb-1" data-toggle="modal" data-target="#hapusmenuBeranda<?= $am['id'];?>">Hapus</a>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
...
<!-- Edit Menu -->
<p hidden><?= $nomor = 1; ?></p>
<?php foreach ($admin_menu as $am) : $nomor++; ?>
  <div class="modal fade" id="tambahmenuEdit<?= $am['id'];?>" tabindex="-1" role="dialog" aria-labelledby="tambahmenuEditLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form action="<?= base_url('admin_menu/edit'); ?>" method="POST">
...
<p hidden><?= $nomor = 1; ?></p>
<?php foreach ($admin_menu as $am) : $nomor++; ?>
<div class="modal fade" id="hapusmenuBeranda<?= $am['id'];?>" tabindex="-1" role="dialog" aria-labelledby="hapusmenuBerandaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="hapusmenuBerandaLabel">Hapus Data Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/hapus'); ?>" method="POST">
