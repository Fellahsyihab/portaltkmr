...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahPRDKModal">Tambah PRODUK</a> 
 ...
 <!-- Page Heading -->
          ...
          <div>
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">PRODUK PUSRI</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>FOTO PRODUK PUSRI</th>
                      <th>NAMA PRODUK PUSRI</th>
                      <th>AKSI</th>
                    </tr>
                  </thead>
                  <tbody>     
                  <?php foreach ($prdk_tkmr as $prdk) : ?>           
                     ...
                     <td> <img class="img-thumbnail" width="180px" src="<?= base_url('front-end/assets/img/produk/'). $prdk['image']?>" class="img-thumbnail" alt=""></td>
                     <td><?=$prdk['judul']?></td>
                     <td>
                        <a href="<?= base_url('admin_menu/edit_prdk/') . $prdk['id'];?>" class="btn btn-sm btn-warning">Edit</a>
    ...
    <!-- Tambah Menu -->
    <div class="modal fade" id="tambahPRDKModal" tabindex="-1" role="dialog" aria-labelledby="tambahPRDKModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahPRDKModalLabel">Tambah Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/prdk_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
        <div class="modal-body">
        <div class="form-group mb-3">
        
        <input type="text" class="form-control" id="judul" name="judul" placeholder="NAMA PRODUK">
        </div>
        
        <div class="custom-file">
        <input type="file" class="custom-file" id="image" name="image" placeholder="PRODUK">
