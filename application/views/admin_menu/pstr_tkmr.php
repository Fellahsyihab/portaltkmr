...
<body id="page-top">
 ...
 <a href="" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahpstrtkmrModal">Tambah POSTER</a> 
 ...
 <!-- Page Heading -->
    ...
    <div class="card shadow mb-4">
                ...
                <img src="<?= base_url('front-end/assets/img/poster/') . $psmr['image']?>" class="img-thumbnail" alt="">
              </div>
              </div>
           </div>
           <?php endforeach; ?>
    ...
    <!-- Tambah Menu -->
    <div class="modal fade" id="tambahpstrtkmrModal" tabindex="-1" role="dialog" aria-labelledby="tambahpstrtkmrModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambahpstrtkmrModalLabel">Tambah Menu</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="<?= base_url('admin_menu/pstr_tkmr'); ?>" method="POST"   enctype="multipart/form-data"     >
        <div class="modal-body">
        <div class="form-group mb-3">
        <input type="text" class="form-control" id="text" name="text" placeholder="Jabatan">
        </div>
